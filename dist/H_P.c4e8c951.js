...
function Media(props) {
  var mediaDevice = props.picture ? React.createElement("img", {
    src: props.picture
...
function ProjectCard(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "desc"
  }, data.desc, data.link != undefined && React.createElement("div", null, React.createElement("br", null), React.createElement("a", {
    href: data.link
  }, "Visit This Project!"))), React.createElement("h5", {
    className: "length"
  }, "Status: ", data.length), React.createElement(Media, {
    video: data.video,
    picture: data.picture
  }), React.createElement("ul", {
    className: "keywords"
  }, keywords), React.createElement(_IconLink.default, {
    className: "gitHub",
    data: {
      url: data.gitHub,
      id: data.id + "icon",
  ...
  }), data.attribution != undefined && React.createElement("h6", null, data.attribution));
}

function ProjectList() {
  var projects = _projectList.default.map(function (project) {
...
function HobbiesAndProjects() {
  React.useEffect(_checkCDN.default); //make sure all required libaries are imported (I know its a bit redundant to check to see if react exists)
