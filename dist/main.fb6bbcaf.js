...
function () {
  _createClass(App, [{
    key: "transition",
    value: function transition(targets, step) {
      var duration = 1000;
      var from = step == "enter" ? 0 : 1;
      var to = step == "enter" ? 1 : 0;
      targets.style.opacity = from;
      var opacity = to;
        ...
        barba.init({
          transitions: [{
            ...
            enter: function enter(_ref) {
              var next = _ref.next;
              return _this.transition(next.container, 'enter');
            },
            leave: function leave(_ref2) {
              var current = _ref2.current;
              return _this.transition(current.container, 'leave');
            }
          }]
        });
      } catch (err) {
...
$(document).ready(function () {
  $("#mobile-dropdown-button").click(function () {
    element = document.getElementById("mobile-dropdown-button");
